package potato.modules.navigation
{
	...
	public interface IView extends IDisposable, IVisible, IResizable
	{
        ...
        function addView(view:String, opts:Object=null):ViewLoader;
		function removeView(view:String):void;
		function changeView(view:String, opts:Object=null):ViewLoader;
		function loaderFor(view:String, opts:Object=null):ViewLoader;
	}
