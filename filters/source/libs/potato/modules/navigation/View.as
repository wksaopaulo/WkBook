package potato.modules.navigation
{
    ...
    */
    ...
    {
      return nav.root.nav.addView(id, opts);
    }
    ...
    {
      return nav.changeView(id, opts);
    }

    public function loaderFor(view:String, opts:Object=null):ViewLoader
    {
      return nav.loaderFor(view, opts);
    }
