package potato.modules.navigation
{
	...
	public class NavigationController extends TreeController
	{
		 ...
		 */
		public function loaderFor(id:String, opts:Object):ViewLoader
		{
			//Generate the loader
			...
			if(vl)
			{
				...
				if(opts){
					//Progress callback
					if(opts.onProgress)
						vl.addEventListener(ProgressEvent.PROGRESS, opts.onProgress, false, 0, true); //Weak

					//Completion callback
					if(opts.onComplete){
						vl.addEventListener(Event.COMPLETE, opts.onComplete, false, 0, true); //Weak
					}
				}
		 ...
		 */
		public function addView(id:String, opts:Object=null):ViewLoader
		{
			...
			//Get the loader
			var loader:ViewLoader = loaderFor(id, opts);
     ...
     * */
		public function changeView(id:String, opts:Object=null):ViewLoader
		{
